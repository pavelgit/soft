...
from quandl.set_providers.DifferenceSetProvider import DifferenceSetProvider
from quandl.learning_setups import create_tensor_board
import keras


class aapl_2004_basic_net_difference_set_provider_setup:
    ...
    def fit(self):
        ...
        set_provider = DifferenceSetProvider()
